...
typedef unsigned int dx12Index_t;
...
typedef struct {
	...
	orientationr_t			orient;					// for current entity // was or
...
{
	dx12Index_t	indexes[SHADER_MAX_INDEXES] QALIGN(16);
